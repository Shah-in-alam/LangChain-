<h1 align="center">🤖 LangChain + Gemini + Hugging Face AI Playground </h1>
...
It allows you to experiment with both **cloud and local LLMs**, pipeline setups, and custom chat interfaces — all in one place!  

💬 Ask questions.  
🧠 Run inference locally.  
⚙️ Chain models together.  
🚀 Build and scale intelligent agents.
